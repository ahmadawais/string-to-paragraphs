...
```sh
npm install string-to-paragraphs
```
...
```js
const stringToParagraphs = require('string-to-paragraphs');
```
...
### stringToParagraphs(input, options?)
...
Type: `object`<br>
Default: `{sentencesPerPara: 3}` (optional)
